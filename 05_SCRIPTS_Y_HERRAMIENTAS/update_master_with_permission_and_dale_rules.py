...
### 3. 📷 ESTÁNDAR FOTOGRÁFICO DEFINITIVO Y FORMATO HORIZONTAL (16:9 MULTIREDES)
...
### 4. 📐 ESTRUCTURA DE LA PORTADA (6 SECCIONES EN CARRUSEL HORIZONTAL)
...
### 5. 🧠 REGLAS DE REDACCIÓN, ESTÍMULOS SUPERNORMALES Y CERO EMOJIS / LÍNEAS
...
add_sec("2. AUTORIZACIÓN TOTAL DE EJECUCIÓN DE SCRIPTS Y PROTOCOLO 'DALE'", [
    "• EJECUCIÓN DIRECTA SIN PEDIR PERMISOS NUNCA: Prohibido interrumpir con solicitudes emergentes o pedir permisos para ejecutar comandos de consola o scripts de Python. El asistente tiene autorización absoluta para ejecutar Python y actualizar archivos de forma transparente.",
    "• PROTOCOLO DE CONFIRMACIÓN CON 'DALE': Para avanzar a la redacción, modificación o publicación de contenido estratégico, el asistente esperará siempre que Daniel le diga 'DALE' o le dé su visto bueno explícito antes de proceder."
])

add_sec("3. ESTÁNDAR FOTOGRÁFICO DEFINITIVO Y FORMATO HORIZONTAL (16:9 MULTIREDES)", [
    "• FORMATO OFICIAL HORIZONTAL (16:9): Las imágenes oficiales de artículos se generan en formato Horizontal (16:9) para permitir su uso óptimo en Blogger, Facebook, LinkedIn, Twitter/X y WhatsApp.",
    "• ADAPTACIÓN A PORTADA (MINIATURA CUADRADA 1:1): Para el carrusel de la portada principal de la web, la misma imagen horizontal se adapta a 1:1 (object-fit: cover).",
    "• ENFOQUE Y COLORES (ALT2 + ALT5 EQUIPETROL): Macro divisas con iluminación crepuscular dorada sobre fondo oscuro chiaroscuro."
])

add_sec("4. ESTRUCTURA DE LA PORTADA (CARRUSEL HORIZONTAL)", [
    "1. ÚLTIMAS ENTRADAS DEL BLOG: Carrusel de artículos con botón 'Ver todas las entradas ➔'.",
    "2. SERVICIOS DE ESTRUCTURACIÓN: Destilado de Ideas, FORJA, Marketing 360°, Impulso MYPE.",
    "3. PROYECTOS PROPIOS & INVESTIGACIÓN: Modelo MFEIR, El Juego del Emprendedor.",
...
add_sec("5. REGLAS DE REDACCIÓN, ESTÍMULOS SUPERNORMALES Y CERO EMOJIS / LÍNEAS", [
...
add_sec("6. METODOLOGÍA OFICIAL DE PROPUESTA, REDACCIÓN Y PUBLICACIÓN AUTOMÁTICA", [
    ...
    "3. Redacción e Imagen Horizontal: Redacción bajo normas de Neuro-Redacción Utilitaria e imagen .webp oficial Horizontal (16:9).",
    "4. Publicación Directa vía API: El asistente publica la entrada directamente en Blogger vía API.",
    "5. Revisión y Subida de Imagen por Daniel: Daniel sube la imagen horizontal en Blogger.",
...
print("SUCCESS: Updated Master MD and DOCX with Direct Python Execution & 'DALE' Confirmation Protocol Rule!")
