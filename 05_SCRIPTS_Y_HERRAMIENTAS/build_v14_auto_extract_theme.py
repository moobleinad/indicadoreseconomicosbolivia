...
output_path = os.path.join(output_dir, "v14_theme_optimizado.xml")
...
# SEO Block
seo_block = """
  <!-- OPTIMIZACION SEO V14 DANIEL SIMONS -->
...
css_block = """
  ...
  /*<![CDATA[*/
    ...
    /* MINIATURA EXTRAÍDA AUTOMÁTICAMENTE */
    .ds-card-thumb {
      width: 100% !important;
      height: auto !important;
  ...
  //<![CDATA[
    ...
    // AUTOMATIC IMAGE EXTRACTION FROM LIVE PAGES & POSTS (Zero XML Size Inflation!)
    document.addEventListener("DOMContentLoaded", function() {
      var cards = document.querySelectorAll(".ds-card-box[data-page-url]");
      cards.forEach(function(card) {
        var url = card.getAttribute("data-page-url");
        var imgTarget = card.querySelector(".ds-card-thumb");
        if (url && imgTarget) {
          fetch(url)
            ...
            .then(function(html) {
              ...
              var firstImg = doc.querySelector(".post-body img, article img, .page_body img, #main img");
              if (firstImg && firstImg.src) {
                imgTarget.src = firstImg.src;
              }
            })
            .catch(function(err) { console.log("Auto-extract notice:", err); });
        }
      });
    });
  //]]>
...
# HTML Frontpage Block V14 with Dynamic Auto-Extraction Data Attributes
            ...
            <b:if cond='data:view.isHomepage'>
              ...
              <section class="ds-section-block">
                ...
                <div class="ds-carousel-track" id="track-posts">
                  <a href="{URL_POST_1}" data-page-url="{URL_POST_1}" class="ds-card-box">
                    <div>
                      <img src="https://images.unsplash.com/photo-1522202176988-66273c2fd55f?auto=format&amp;fit=crop&amp;w=600&amp;h=600&amp;q=80" alt="De la idea escolar al proyecto ordenado" class="ds-card-thumb" />
              ...
              <section class="ds-section-block">
                ...
                <div class="ds-carousel-track" id="track-services">
                  <a href="{URL_DESTILADO}" data-page-url="{URL_DESTILADO}" class="ds-card-box">
                    <div>
                      <img src="https://images.unsplash.com/photo-1455390582262-044cdead277a?auto=format&amp;fit=crop&amp;w=600&amp;h=600&amp;q=80" alt="Destilado de Ideas" class="ds-card-thumb" />
                  ...
                  <a href="{URL_FORJA}" data-page-url="{URL_FORJA}" class="ds-card-box">
                    <div>
                      <img src="https://images.unsplash.com/photo-1507679799987-c73779587ccf?auto=format&amp;fit=crop&amp;w=600&amp;h=600&amp;q=80" alt="Forja de Proyectos" class="ds-card-thumb" />
                  ...
                  <a href="{URL_MARKETING}" data-page-url="{URL_MARKETING}" class="ds-card-box">
                    <div>
                      <img src="https://images.unsplash.com/photo-1460925895917-afdab827c52f?auto=format&amp;fit=crop&amp;w=600&amp;h=600&amp;q=80" alt="Marketing 360°" class="ds-card-thumb" />
                  ...
                  <a href="{URL_MYPE}" data-page-url="{URL_MYPE}" class="ds-card-box">
                    <div>
                      <img src="https://images.unsplash.com/photo-1556761175-5973dc0f32e7?auto=format&amp;fit=crop&amp;w=600&amp;h=600&amp;q=80" alt="Impulso MYPE" class="ds-card-thumb" />
              ...
              <section class="ds-section-block">
                ...
                <div class="ds-carousel-track" id="track-projects">
                  <a href="{URL_MFEIR}" data-page-url="{URL_MFEIR}" class="ds-card-box">
                    <div>
                      <img src="https://images.unsplash.com/photo-1451187580459-43490279c0fa?auto=format&amp;fit=crop&amp;w=600&amp;h=600&amp;q=80" alt="Modelo MFEIR" class="ds-card-thumb" />
                  ...
                  <a href="{URL_JUEGO}" data-page-url="{URL_JUEGO}" class="ds-card-box">
                    <div>
                      <img src="https://images.unsplash.com/photo-1544716278-ca5e3f4abd8c?auto=format&amp;fit=crop&amp;w=600&amp;h=600&amp;q=80" alt="El Juego del Emprendedor" class="ds-card-thumb" />
              ...
              <section class="ds-section-block">
                ...
                <div class="ds-carousel-track" id="track-work">
                  <a href="{URL_URBANIZACIONES}" data-page-url="{URL_URBANIZACIONES}" class="ds-card-box">
                    <div>
                      <img src="https://images.unsplash.com/photo-1486406146926-c627a92ad1ab?auto=format&amp;fit=crop&amp;w=600&amp;h=600&amp;q=80" alt="Propuesta Urbanizaciones" class="ds-card-thumb" />
                  ...
                  <a href="{URL_TRANSPARENCIA}" data-page-url="{URL_TRANSPARENCIA}" class="ds-card-box">
                    <div>
                      <img src="https://images.unsplash.com/photo-1450133064473-71024230f91b?auto=format&amp;fit=crop&amp;w=600&amp;h=600&amp;q=80" alt="Transparencia Inteligente" class="ds-card-thumb" />
                  ...
                  <a href="{URL_ELECTORAL}" data-page-url="{URL_ELECTORAL}" class="ds-card-box">
                    <div>
                      <img src="https://images.unsplash.com/photo-1540910419892-4a36d2c3266c?auto=format&amp;fit=crop&amp;w=600&amp;h=600&amp;q=80" alt="Estrategia Electoral 2026" class="ds-card-thumb" />
                  ...
                  <a href="{URL_TESIS}" data-page-url="{URL_TESIS}" class="ds-card-box">
                    <div>
                      <img src="https://images.unsplash.com/photo-1434030216411-0b793f4b4173?auto=format&amp;fit=crop&amp;w=600&amp;h=600&amp;q=80" alt="Guía Sobreviviendo a la Tesis" class="ds-card-thumb" />
                  ...
                  <a href="{URL_MARCA}" data-page-url="{URL_MARCA}" class="ds-card-box">
                    <div>
                      <img src="https://images.unsplash.com/photo-1557804506-669a67965ba0?auto=format&amp;fit=crop&amp;w=600&amp;h=600&amp;q=80" alt="Evaluar Desarrollo de Marca" class="ds-card-thumb" />
...
try:
    ...
    print("SUCCESS: v14_theme_optimizado.xml created and passed XML test!")
