...
### 6. 📁 ESTRUCTURA DE ARCHIVOS Y CARPETAS DEDICADAS
- **CARPETAS DEDICADAS DEL PROYECTO:**
  - `00_DOCUMENTOS_ESTRATÉGICOS/`
  - `01_LINEA_GRAFICA_Y_ASSETS/`
  - `02_ARTICULOS_Y_PUBLICACIONES/` (Cada artículo en su subcarpeta dedicada)
  - `03_TEMAS_Y_PLANTILLAS_XML/`
  - `04_API_BLOGGER_Y_AUTENTICACION/`
  - `05_SCRIPTS_Y_HERRAMIENTAS/`
  - `08_INDICADORES_ECONOMICOS/`
  - `09_IMAGENES_PAGINAS_ESTATICAS/` (Imágenes de previsualización para páginas `/p/*.html`)
...
add_sec("2. AUTORIZACIÓN TOTAL DE EJECUCIÓN DE SCRIPTS Y PROTOCOLO 'DALE'", [
    "• EJECUCIÓN DIRECTA SIN PEDIR PERMISOS NUNCA: Prohibido interrumpir con solicitudes emergentes.",
    "• PROTOCOLO DE CONFIRMACIÓN CON 'DALE': Esperar siempre la aprobación de Daniel."
])
...
add_sec("4. CARPETA DEDICADA 09_IMAGENES_PAGINAS_ESTATICAS/ Y PROTOCOLO 16:9", [
    "• CARPETA DEDICADA: Todas las imágenes de previsualización para páginas estáticas se guardan en 09_IMAGENES_PAGINAS_ESTATICAS/.",
    "• FORMATO HORIZONTAL (16:9): Generación oficial en .webp 16:9.",
    "• SUBIDA MANUAL POR DANIEL: Daniel sube la imagen al final del editor en Blogger.",
    "• CONFIRMACIÓN CON LINK CDN: Daniel comparte la URL de Blogger CDN."
])
...
add_sec("6. ESTRUCTURA DE ARCHIVOS Y CARPETAS DEDICADAS", [
    "• 09_IMAGENES_PAGINAS_ESTATICAS/ (Imágenes de previsualización para páginas /p/*.html)"
])

add_sec("7. LÍMITES TÉCNICOS Y PESO EN BLOGGER", [
    "• Peso Máximo del XML: NUNCA DEBE SUPERAR LOS 200 KB.",
    "• CLÁUSULA DE CONTROL ABSOLUTO: Sólo modificar lo explícitamente instruido."
])

doc.save(master_docx_path)
print("SUCCESS: Updated Master MD and DOCX with 09_IMAGENES_PAGINAS_ESTATICAS Folder Rule!")
