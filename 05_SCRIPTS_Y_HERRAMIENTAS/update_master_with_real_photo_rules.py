...
### 2. 📷 ESTILO FOTOGRÁFICO AUTÉNTICO (SMARTPHONE REAL / SANTA CRUZ DE LA SIERRA)
- **ESTILO FOTOGRÁFICO REALISTA:** Las imágenes de artículos deben ser fotografías que parezcan **100% reales**, como tomadas por un aficionado con un celular smartphone promedio en una excelente toma cotidiana.
- **PROHIBICIÓN DE 3D Y FOTO DE STOCK:** Cero renders 3D de plástico, cero ilustraciones fantasiosas y cero fotos de stock extranjeras.
- **PERSONAS Y CONTEXTO SANTA CRUZ:**
  - **Personas:** Bolivianos reales con el aspecto cotidiano auténtico de la gente de Santa Cruz de la Sierra (comerciantes, trabajadores, emprendedores y ciudadanos reales).
  - **Lugares:** Escenarios cotidianos y urbanos reales de Santa Cruz de la Sierra, **sin exageraciones ni estereotipos absurdos**.
- **Paleta de Portada:**
...
3. **Presentación de Borrador Directo e Imagen:** El asistente redacta el artículo bajo normas de **Neuro-Redacción Utilitaria** (sin emojis ni líneas separadoras) y entrega la imagen `.webp` oficial realista tomada estilo celular.
...
- **CARPETAS INDIVIDUALES POR ARTÍCULO:** Cada artículo se organizará dentro de su propia carpeta dedicada en `02_ARTICULOS_Y_PUBLICACIONES/` conteniendo exclusivamente sus 3 archivos:
  ...
  - Imagen `.webp` oficial realista (Estilo foto de celular real en Santa Cruz)
...
add_sec("2. ESTILO FOTOGRÁFICO AUTÉNTICO (SMARTPHONE REAL / SANTA CRUZ DE LA SIERRA)", [
    "• ESTILO FOTOGRÁFICO REALISTA: Las imágenes de artículos deben ser fotografías que parezcan 100% reales, como tomadas por un aficionado con un celular smartphone promedio en una excelente toma cotidiana.",
    "• PROHIBICIÓN DE 3D Y FOTO DE STOCK: Cero renders 3D de plástico, cero ilustraciones fantasiosas y cero fotos de stock extranjeras.",
    "• PERSONAS Y CONTEXTO SANTA CRUZ: Personas bolivianas reales con el aspecto cotidiano auténtico de Santa Cruz de la Sierra (comerciantes, trabajadores, emprendedores). Escenarios urbanos y comerciales reales de Santa Cruz, sin exageraciones ni estereotipos absurdos."
])
...
add_sec("5. METODOLOGÍA OFICIAL DE PROPUESTA, SELECCIÓN, REDACCIÓN Y APROBACIÓN DE ARTÍCULOS", [
    ...
    "3. Presentación de Borrador Directo e Imagen: Redacción bajo normas de Neuro-Redacción Utilitaria (sin emojis ni líneas separadoras) e imagen .webp realista estilo celular.",
...
add_sec("6. ESTRUCTURA DE ARTÍCULOS EN CARPETAS DEDICADAS Y SISTEMA NUMÉRICO", [
    "• CARPETAS INDIVIDUALES POR ARTÍCULO: Cada artículo se organizará dentro de su propia carpeta dedicada en 02_ARTICULOS_Y_PUBLICACIONES/ conteniendo exclusivamente sus 3 archivos: archivo .md (sin emojis/líneas), archivo .docx y su imagen .webp oficial realista.",
...
print("SUCCESS: Updated Master MD and DOCX with Realistic Smartphone Photography & Santa Cruz Context Rules!")
