...
# Service thumbnails (Executive Rembrandt style for Destilado & Forja)
...
# HTML Frontpage Block V17 (EXACT 4 SERVICES: DESTILADO, FORJA, MARKETING 360, IMPULSO MYPE)
frontpage_html_block = f"""
            <b:if cond='data:view.isHomepage'>
              ...
              <!-- SECCIÓN 2: SERVICIOS DE ESTRUCTURACIÓN (DESTILADO, FORJA, MARKETING 360, IMPULSO MYPE) -->
              <section class="ds-section-block">
                <div class="ds-section-header">
