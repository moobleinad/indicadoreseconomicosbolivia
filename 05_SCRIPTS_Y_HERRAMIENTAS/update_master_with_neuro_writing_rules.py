...
### 4. 🧠 REGLAS DE REDACCIÓN, NEUROCIENCIA Y ESTÍMULOS SUPERNORMALES
- **CERO VERBORREA Y CERO HISTORIA ABURRIDA:** Prohibido prólogos académicos, introducciones históricas largas o textos estilo "libro de historia para viejos aburridos".
...
- **TÉCNICAS DE ESTÍMULOS SUPERNORMALES (NEURO-COGNICIÓN):**
  - **Títulos Impactantes y Utilitarios:** Claros, vibrantes, sin rodeos.
  - **Densidad de Información Útil:** Máxima sustancia técnica por línea.
  - **Ganchos de Acción Inmediata:** Maximizar intencionalmente la probabilidad de que el lector haga clic en los enlaces de servicio, contacte directamente por WhatsApp o avance al siguiente artículo.
...
3. **Presentación de Borrador Directo e Imagen:** El asistente redacta el artículo bajo normas de **Neuro-Redacción Utilitaria** (AIDA) y entrega la imagen `.webp` oficial.
...
add_sec("4. REGLAS DE REDACCIÓN, NEUROCIENCIA Y ESTÍMULOS SUPERNORMALES", [
    "• CERO VERBORREA Y CERO HISTORIA ABURRIDA: Prohibido prólogos académicos o introducciones históricas largas.",
    "• ENFOQUE GERENCIAL Y AHORRO DE TIEMPO: Redacción ultra-práctica, directa al grano, utilitaria y quirúrgicamente ejecutiva.",
    "• TÉCNICAS DE ESTÍMULOS SUPERNORMALES (NEURO-COGNICIÓN): Títulos impactantes, máxima sustancia técnica por línea y ganchos directos para maximizar la conversión hacia WhatsApp, servicios o el siguiente artículo."
])
...
add_sec("5. METODOLOGÍA OFICIAL DE PROPUESTA, SELECCIÓN, REDACCIÓN Y APROBACIÓN DE ARTÍCULOS", [
    ...
    "3. Presentación de Borrador Directo e Imagen: Redacción bajo normas de Neuro-Redacción Utilitaria e imagen .webp.",
...
add_sec("6. SISTEMA NUMÉRICO Y NORMAS DE ORGANIZACIÓN DE ARCHIVOS", [
    "• Jerarquía Numérica: Carpetas y archivos organizados con prefijo numérico (00_..., 01_...).",
    "• Subdivisión Decimal: Documentos internos numerados decimalmente (00.01_..., 00.02_...)."
])
...
print("SUCCESS: Updated Master MD and DOCX with Neuro-Cognitive Writing Rules!")
