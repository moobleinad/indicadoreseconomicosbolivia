...
clean_html = f'''<div style="font-family: system-ui, -apple-system, sans-serif; background-color: #0d0d0d; color: #ffffff; padding: 20px; border-radius: 12px; border: 1px solid rgba(188, 167, 114, 0.3); max-width: 800px; margin: 0 auto;">
...
print("FILE CREATED FOR EASY COPY-PASTE:", copy_paste_path)
