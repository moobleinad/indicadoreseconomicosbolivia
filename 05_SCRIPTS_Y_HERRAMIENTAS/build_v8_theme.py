...
output_path = os.path.join(output_dir, "v8_theme_optimizado.xml")
...
seo_block = """
  <!-- OPTIMIZACION SEO V8 DANIEL SIMONS -->
...
# 2. Strict CSS: Pure Black #000000, 100px margins on PC (max-width: 1040px with padding 0 40px), styling for native Blogger Header widget
css_block = """
  <style type='text/css'>
  /*<![CDATA[*/
    ...
    /* MARGEN Y ANCHO DE PC: CONTENEDOR CENTRADO CON MÁRGENES LATERALES ELEGANTES */
    ...
    /* ESTILO PARA LA CABECERA OFICIAL DE BLOGGER (CONFIGURADA POR DANIEL) */
...
# 3. HTML Block for Front Page WITHOUT ANY REPEATED HEADER (Relies ONLY on Blogger's native header widget!)
...
try:
    ...
    print("SUCCESS: v8_theme_optimizado.xml created and passed XML test!")
