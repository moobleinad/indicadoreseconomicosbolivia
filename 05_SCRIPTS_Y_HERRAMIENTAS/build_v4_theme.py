...
output_path = os.path.join(output_dir, "v4_theme_optimizado.xml")
...
seo_block = """
  <!-- OPTIMIZACION SEO Y META TAGS OPEN GRAPH (VERSION v4) -->
...
# 2. Enhanced CSS Block for v4 (Pure Black #000000 matching image backgrounds + NO SIDEBAR AT ALL)
css_block = """
  <style type='text/css'>
  /*<![CDATA[*/
    /* FONDO NEGRO PURO UNIFORME (#000000) MATCH CON LAS IMÁGENES */
    ...
    /* ELIMINAR COMPLETAMENTE LA BARRA LATERAL IZQUIERDA Y HAMBURGUESA */
    .sidebar-container, 
    ...
    /* AMPLIAR EL CONTENIDO PRINCIPAL A 100% ANCHO COMPLETO */
    #main, 
    .page, 
    .centered-bottom, 
    ...
    /* BARRA DE SENDAS Y SERVICIOS EN PORTADA (NEGRO PURO Y DORADO) */
    .ds-sendas-bar {
      background: #000000;
    ...
    /* IMÁGENES SIN BORDES NI FONDOS EXTRAÑOS */
    .post-body img, .snippet-thumbnail img {
      background-color: #000000 !important;
...
# 3. HTML Block for Sendas Bar
sendas_html_block = f"""
            <b:if cond='data:view.isHomepage'>
              <!-- BARRA DE SERVICIOS Y SENDAS DANIEL SIMONS (VERSION v4) -->
...
# 4. AI Chatbot Widget HTML & JS Block
widget_block = f"""
  <style type='text/css'>
  /*<![CDATA[*/
...
try:
    ...
    print("SUCCESS: v4_theme_optimizado.xml passed strict XML parsing test!")
