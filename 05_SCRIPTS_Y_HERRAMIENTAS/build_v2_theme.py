...
output_path = os.path.join(output_dir, "v2_theme_optimizado.xml")
...
# 1. SEO & Open Graph Meta Tags (Valid XHTML)
seo_block = """
  <!-- OPTIMIZACION SEO Y META TAGS OPEN GRAPH (VERSION v2) -->
  <b:if cond='data:view.isSingleItem'>
    ...
    <b:else/>
      <meta expr:content='data:view.title.escaped + " - Trabajo intelectual, análisis de proyectos, estrategias y recursos docentes por Daniel Simons."' name='description'/>
      <meta expr:content='data:view.title.escaped + " - Trabajo intelectual, análisis de proyectos, estrategias y recursos docentes por Daniel Simons."' property='og:description'/>
      <meta expr:content='data:view.title.escaped + " - Trabajo intelectual, análisis de proyectos, estrategias y recursos docentes por Daniel Simons."' name='twitter:description'/>
    </b:if>
    <meta content='article' property='og:type'/>
  <b:else/>
    <meta content='Daniel Simons | Emprendimientos, Proyectos Productivos &amp; Trabajo Intelectual' property='og:title'/>
    <meta content='Daniel Simons | Emprendimientos, Proyectos Productivos &amp; Trabajo Intelectual' name='twitter:title'/>
...
# 2. Enhanced CSS Block for v2 (Clean 100% Full-Width Homepage, No duplication)
css_block = """
  <style type='text/css'>
  /*<![CDATA[*/
    body {
    ...
    /* En la PORTADA: Ocultar sidebar para dar 100% de ancho y elegancia */
    ...
    /* BARRA DE SENDAS Y CATEGORÍAS EN PORTADA */
    .ds-sendas-bar {
      background: #131720;
...
# 3. HTML Block for Sendas Bar (Injected into Main on Homepage)
sendas_html_block = """
            <b:if cond='data:view.isHomepage'>
              <!-- BARRA DE SENDAS DE CONTENIDO DANIEL SIMONS (VERSION v2) -->
              <nav class="ds-sendas-bar">
                <a href="#articulos-ds" class="ds-senda-item">
                  <span>🧠</span> Trabajo Intelectual &amp; Análisis
                </a>
                <a href="#servicios-ds" class="ds-senda-item">
                  <span>🛠️</span> Servicios para Emprendimientos
                </a>
                <a href="#academico-ds" class="ds-senda-item">
                  <span>📚</span> Docencia &amp; Historia Económica
                </a>
              </nav>

              <div class="ds-section-divider">
                <span>PORTAFOLIO DE PUBLICACIONES</span>
                <h2>Últimos Análisis, Servicios &amp; Recursos</h2>
              </div>
            </b:if>
"""

# 4. AI Chatbot Widget HTML & JS Block (XML Safe)
widget_block = """
  <style type='text/css'>
  /*<![CDATA[*/
    ...
    <div id="ds-ai-modal">
      ...
      <div class="ds-ai-body" id="dsAiBody">
        <div class="ds-ai-msg ds-ai-msg-bot">
          ¡Hola! 👋 Soy el asistente de <strong>Daniel Simons</strong>. ¿Qué consulta o proyecto deseas explorar hoy?
        </div>
  ...
  //<![CDATA[
    ...
    function processDsAiBotResponse(query) {
      ...
      if (q.indexOf("destilado") !== -1 || q.indexOf("idea") !== -1) {
        reply = "🧪 <strong>Destilado de Ideas de Negocio:</strong><br/>Proceso de purificación y validación estratégica para proyectos y emprendimientos.<br/><br/><a href='https://www.danielsimons.xyz/2025/11/evaluar-mi-marca-online.html' target='_blank' style='color:#bca772; font-weight:bold;'>👉 Ver Detalle de Servicios</a>";
      } else if (q.indexOf("forja") !== -1 || q.indexOf("proyecto") !== -1) {
        reply = "🔨 <strong>Forja de Emprendimientos:</strong><br/>Estructuración, moldeado y construcción sólida de proyectos productivos.<br/><br/><a href='https://www.danielsimons.xyz/2025/11/evaluar-mi-marca-online.html' target='_blank' style='color:#bca772; font-weight:bold;'>👉 Ver Detalle de Forja</a>";
      } else if (q.indexOf("marketing") !== -1 || q.indexOf("mype") !== -1) {
        reply = "📈 <strong>Marketing 360° &amp; Impulso MYPE:</strong><br/>Estrategias integrales de crecimiento y aceleración comercial para empresas y PYMEs.<br/><br/><a href='https://www.danielsimons.xyz/2025/11/evaluar-mi-marca-online.html' target='_blank' style='color:#bca772; font-weight:bold;'>👉 Ver Servicios 360</a>";
...
try:
    ...
    print("SUCCESS: v2_theme_optimizado.xml passed strict XML parsing test!")
