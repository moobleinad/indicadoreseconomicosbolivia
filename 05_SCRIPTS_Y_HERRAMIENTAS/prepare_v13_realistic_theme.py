...
output_path = os.path.join(output_dir, "v13_theme_optimizado.xml")
...
# Clean high-def realistic photography URLs with XML-encoded &amp;
FALLBACK_ART1 = "https://images.unsplash.com/photo-1522202176988-66273c2fd55f?auto=format&amp;fit=crop&amp;w=600&amp;h=600&amp;q=80"
FALLBACK_DESTILADO = "https://images.unsplash.com/photo-1455390582262-044cdead277a?auto=format&amp;fit=crop&amp;w=600&amp;h=600&amp;q=80"
FALLBACK_FORJA = "https://images.unsplash.com/photo-1507679799987-c73779587ccf?auto=format&amp;fit=crop&amp;w=600&amp;h=600&amp;q=80"
FALLBACK_MKT = "https://images.unsplash.com/photo-1460925895917-afdab827c52f?auto=format&amp;fit=crop&amp;w=600&amp;h=600&amp;q=80"
FALLBACK_MYPE = "https://images.unsplash.com/photo-1556761175-5973dc0f32e7?auto=format&amp;fit=crop&amp;w=600&amp;h=600&amp;q=80"
FALLBACK_JUEGO = "https://images.unsplash.com/photo-1544716278-ca5e3f4abd8c?auto=format&amp;fit=crop&amp;w=600&amp;h=600&amp;q=80"
FALLBACK_MFEIR = "https://images.unsplash.com/photo-1451187580459-43490279c0fa?auto=format&amp;fit=crop&amp;w=600&amp;h=600&amp;q=80"
FALLBACK_URBAN = "https://images.unsplash.com/photo-1486406146926-c627a92ad1ab?auto=format&amp;fit=crop&amp;w=600&amp;h=600&amp;q=80"
FALLBACK_TRANSP = "https://images.unsplash.com/photo-1450133064473-71024230f91b?auto=format&amp;fit=crop&amp;w=600&amp;h=600&amp;q=80"
FALLBACK_ELECT = "https://images.unsplash.com/photo-1540910419892-4a36d2c3266c?auto=format&amp;fit=crop&amp;w=600&amp;h=600&amp;q=80"
FALLBACK_TESIS = "https://images.unsplash.com/photo-1434030216411-0b793f4b4173?auto=format&amp;fit=crop&amp;w=600&amp;h=600&amp;q=80"
FALLBACK_MARCA = "https://images.unsplash.com/photo-1557804506-669a67965ba0?auto=format&amp;fit=crop&amp;w=600&amp;h=600&amp;q=80"

# SEO Block
seo_block = """
  <!-- OPTIMIZACION SEO V13 DANIEL SIMONS -->
...
css_block = """
  ...
  /*<![CDATA[*/
    ...
    /* MINIATURA FOTOGRÁFICA REALISTA QUE LLENA EL 100% DE LA TARJETA */
    .ds-card-thumb {
      width: 100% !important;
      height: auto !important;
...
frontpage_html_block = f"""
            <b:if cond='data:view.isHomepage'>
              ...
              <section class="ds-section-block">
                ...
                <div class="ds-carousel-track" id="track-posts">
                  <a href="{URL_POST_1}" class="ds-card-box">
                    <div>
                      <img src="{FALLBACK_ART1}" alt="De la idea escolar al proyecto ordenado" class="ds-card-thumb" />
              ...
              <!-- SECCIÓN 2: SERVICIOS DE ESTRUCTURACIÓN CON FOTOGRAFÍA REALISTA -->
              <section class="ds-section-block">
                <div class="ds-section-header">
                ...
                <div class="ds-carousel-track" id="track-services">
                  <a href="{URL_DESTILADO}" class="ds-card-box">
                    <div>
                      <img src="{FALLBACK_DESTILADO}" alt="Destilado de Ideas" class="ds-card-thumb" />
                  ...
                  <a href="{URL_FORJA}" class="ds-card-box">
                    <div>
                      <img src="{FALLBACK_FORJA}" alt="Forja de Proyectos" class="ds-card-thumb" />
                  ...
                  <a href="{URL_MARKETING}" class="ds-card-box">
                    <div>
                      <img src="{FALLBACK_MKT}" alt="Marketing 360°" class="ds-card-thumb" />
                  ...
                  <a href="{URL_MYPE}" class="ds-card-box">
                    <div>
                      <img src="{FALLBACK_MYPE}" alt="Impulso MYPE" class="ds-card-thumb" />
              ...
              <section class="ds-section-block">
                ...
                <div class="ds-carousel-track" id="track-projects">
                  <a href="{URL_MFEIR}" class="ds-card-box">
                    <div>
                      <img src="{FALLBACK_MFEIR}" alt="Modelo MFEIR" class="ds-card-thumb" />
                  ...
                  <a href="{URL_JUEGO}" class="ds-card-box">
                    <div>
                      <img src="{FALLBACK_JUEGO}" alt="El Juego del Emprendedor" class="ds-card-thumb" />
              ...
              <section class="ds-section-block">
                ...
                <div class="ds-carousel-track" id="track-work">
                  <a href="{URL_URBANIZACIONES}" class="ds-card-box">
                    <div>
                      <img src="{FALLBACK_URBAN}" alt="Propuesta Urbanizaciones" class="ds-card-thumb" />
                  ...
                  <a href="{URL_TRANSPARENCIA}" class="ds-card-box">
                    <div>
                      <img src="{FALLBACK_TRANSP}" alt="Transparencia Inteligente" class="ds-card-thumb" />
                  ...
                  <a href="{URL_ELECTORAL}" class="ds-card-box">
                    <div>
                      <img src="{FALLBACK_ELECT}" alt="Estrategia Electoral 2026" class="ds-card-thumb" />
                  ...
                  <a href="{URL_TESIS}" class="ds-card-box">
                    <div>
                      <img src="{FALLBACK_TESIS}" alt="Guía Sobreviviendo a la Tesis" class="ds-card-thumb" />
                  ...
                  <a href="{URL_MARCA}" class="ds-card-box">
                    <div>
                      <img src="{FALLBACK_MARCA}" alt="Evaluar Desarrollo de Marca" class="ds-card-thumb" />
...
try:
    ...
    print("SUCCESS: v13_theme_optimizado.xml created and passed XML test!")
