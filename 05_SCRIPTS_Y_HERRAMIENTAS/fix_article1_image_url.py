...
print("=== FIXING ARTICLE 1 IMAGE ON BLOGGER CDN ===")

# Search for the published post "De la idea escolar al proyecto ordenado"
posts = service.posts().list(blogId=blog_id).execute().get('items', [])
post_id = None
for p in posts:
    if "idea escolar" in p.get('title', '').lower():
        post_id = p.get('id')
        print("Found Post ID:", post_id)
        break

# Image square path
sq_path = os.path.join(root_dir, "foto_articulo1_bth_cuadrada.jpg")
with open(sq_path, "rb") as f:
    b64_sq = base64.b64encode(f.read()).decode("utf-8")

data_uri_sq = f"data:image/jpeg;base64,{b64_sq}"

# Update the post content with clean data URI image at the top
if post_id:
    post_obj = service.posts().get(blogId=blog_id, postId=post_id).execute()
    current_content = post_obj.get('content', '')
    
    # Prepend top image
    new_content = f'<div style="text-align:center; margin-bottom:20px;"><img src="{data_uri_sq}" alt="De la idea escolar al proyecto ordenado" style="width:100%; max-width:800px; height:auto; border-radius:8px;" /></div>\n' + current_content
    post_obj['content'] = new_content
    
    updated_post = service.posts().update(blogId=blog_id, postId=post_id, body=post_obj).execute()
    print("Post Updated successfully!")
    
    # Re-fetch to get Blogger generated image URL if available
    fetched = service.posts().get(blogId=blog_id, postId=post_id).execute()
    images = fetched.get('images', [])
    print("Fetched Post Images:", images)
    
    if images:
        real_art1_img_url = images[0].get('url')
    else:
        real_art1_img_url = data_uri_sq
else:
    real_art1_img_url = data_uri_sq

print("FINAL REAL ART1 IMAGE URL:", real_art1_img_url[:60] + "...")

# Now build v16_theme_optimizado.xml
...
output_path = os.path.join(output_dir, "v16_theme_optimizado.xml")
...
# SEO Block
seo_block = """
  <!-- OPTIMIZACION SEO V16 DANIEL SIMONS -->
...
css_block = """
  ...
  /*<![CDATA[*/
    ...
    /* MINIATURA REAL QUE LLENA EL 100% DE LA TARJETA */
    .ds-card-thumb {
      width: 100% !important;
      height: auto !important;
...
# HTML Frontpage Block V16
frontpage_html_block = f"""
            <b:if cond='data:view.isHomepage'>

              <!-- SECCIÓN 1: ÚLTIMAS ENTRADAS DEL BLOG CON MINIATURA DE ARTÍCULO 1 CORREGIDA -->
              <section class="ds-section-block">
                ...
                <div class="ds-carousel-track" id="track-posts">
                  <a href="{URL_POST_1}" class="ds-card-box">
                    <div>
                      <img src="{real_art1_img_url}" alt="De la idea escolar al proyecto ordenado" class="ds-card-thumb" />
              ...
              <section class="ds-section-block">
                ...
                <div class="ds-carousel-track" id="track-services">
                  <a href="{URL_DESTILADO}" class="ds-card-box">
                    <div>
                      <img src="{REAL_IMG_JUEGO}" alt="Destilado de Ideas" class="ds-card-thumb" />
                  ...
                  <a href="{URL_FORJA}" class="ds-card-box">
                    <div>
                      <img src="{REAL_IMG_TESIS}" alt="Forja de Proyectos" class="ds-card-thumb" />
                  ...
                  <a href="{URL_MARKETING}" class="ds-card-box">
                    <div>
                      <img src="{REAL_IMG_MARKETING}" alt="Marketing 360°" class="ds-card-thumb" />
                  ...
                  <a href="{URL_MYPE}" class="ds-card-box">
                    <div>
                      <img src="{REAL_IMG_MYPE}" alt="Impulso MYPE" class="ds-card-thumb" />
              ...
              <section class="ds-section-block">
                ...
                <div class="ds-carousel-track" id="track-projects">
                  <a href="{URL_MFEIR}" class="ds-card-box">
                    <div>
                      <img src="{REAL_IMG_MFEIR}" alt="Modelo MFEIR" class="ds-card-thumb" />
                  ...
                  <a href="{URL_JUEGO}" class="ds-card-box">
                    <div>
                      <img src="{REAL_IMG_JUEGO}" alt="El Juego del Emprendedor" class="ds-card-thumb" />
              ...
              <section class="ds-section-block">
                ...
                <div class="ds-carousel-track" id="track-work">
                  <a href="{URL_URBANIZACIONES}" class="ds-card-box">
                    <div>
                      <img src="{REAL_IMG_URBANIZACIONES}" alt="Propuesta Urbanizaciones" class="ds-card-thumb" />
                  ...
                  <a href="{URL_TRANSPARENCIA}" class="ds-card-box">
                    <div>
                      <img src="{REAL_IMG_TRANSPARENCIA}" alt="Transparencia Inteligente" class="ds-card-thumb" />
                  ...
                  <a href="{URL_ELECTORAL}" class="ds-card-box">
                    <div>
                      <img src="{REAL_IMG_MFEIR}" alt="Estrategia Electoral 2026" class="ds-card-thumb" />
                  ...
                  <a href="{URL_TESIS}" class="ds-card-box">
                    <div>
                      <img src="{REAL_IMG_TESIS}" alt="Guía Sobreviviendo a la Tesis" class="ds-card-thumb" />
                  ...
                  <a href="{URL_MARCA}" class="ds-card-box">
                    <div>
                      <img src="{REAL_IMG_MARCA}" alt="Evaluar Desarrollo de Marca" class="ds-card-thumb" />
...
try:
    ...
    print("SUCCESS: v16_theme_optimizado.xml created and passed XML test!")
