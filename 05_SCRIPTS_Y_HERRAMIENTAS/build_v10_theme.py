...
output_path = os.path.join(output_dir, "v10_theme_optimizado.xml")

# Image Data URIs for Square Thumbnails
img_sq_art1 = os.path.join(root_dir, "foto_articulo1_bth_cuadrada.jpg")
img_thumb_destilado = r"C:\Users\Usuario\.gemini\antigravity\brain\953edcf7-5053-4ba6-94e5-82edfed7e1d2\thumb_destilado_1785593994402.jpg"
img_thumb_forja = r"C:\Users\Usuario\.gemini\antigravity\brain\953edcf7-5053-4ba6-94e5-82edfed7e1d2\thumb_forja_1785594011419.jpg"
...
uri_art1 = get_b64(img_sq_art1)
uri_destilado = get_b64(img_thumb_destilado)
uri_forja = get_b64(img_thumb_forja)

with open(source_path, "r", encoding="utf-8") as f:
    xml_content = f.read()

# Live Page & Post URLs on Blogger:
...
# SEO Block
seo_block = """
  <!-- OPTIMIZACION SEO V10 DANIEL SIMONS -->
...
# CSS for V10: Increased Title Font Size on Mobile (15px), Pure Black #000000, 5 Structured Sections
css_block = """
  <style type='text/css'>
  /*<![CDATA[*/
    ...
    /* TIPOGRAFÍA DE TÍTULOS MÁS GRANDE EN CELULARES SEGÚN PEDIDO */
    @media (max-width: 767px) {
      .ds-card-box .title {
...
# HTML Frontpage Block with 5 Structured Sections & Increased Mobile Title Font Size
frontpage_html_block = f"""
            <b:if cond='data:view.isHomepage'>
              ...
              <!-- SECCIÓN 2: SERVICIOS DE CONSULTORÍA -->
              <section class="ds-section-block">
                <div class="ds-section-header">
                ...
                <div class="ds-carousel-track" id="track-services">
                  ...
                  <a href="{URL_MARKETING}" class="ds-card-box">
                    <div>
                      <div class="ds-card-thumb" style="background:#141414; display:flex; flex-direction:column; align-items:center; justify-content:center; color:#bca772; font-weight:800; font-size:18px; border:1px solid rgba(188,167,114,0.3);">
...
try:
    ...
    print("SUCCESS: v10_theme_optimizado.xml created and passed XML test!")
