...
output_path = os.path.join(output_dir, "index_theme_danielsimons.xml")
...
# SVG Header paths (Base64 or clean responsive SVG link)
# 1. SEO & Open Graph Meta Tags
seo_block = """
  <!-- OPTIMIZACION SEO Y INDEX PRESERVADO DANIEL SIMONS -->
...
# 2. Strict CSS: Pure Solid Black #000000 background, Double SVG Header, 6 columns PC, 2 columns Mobile
css_block = """
  <style type='text/css'>
  /*<![CDATA[*/
    ...
    /* CONTROLES DE CABECERA RESPONSIVA (PC VS MÓVIL) */
    .ds-header-pc {
    ...
    /* GRID RESPONSIVO EXACTO: 6 EN PC, 2 EN CELULAR */
...
# 3. HTML Block for Index (Homepage)
frontpage_html_block = f"""
            <b:if cond='data:view.isHomepage'>
              <!-- CABECERA DOBLE RESPONSIVA (PC VS MÓVIL) -->
              <div class="ds-header-pc">
                <img src="https://raw.githubusercontent.com/antigravity/danielsimons/main/cabecera_pc.svg" alt="Daniel Simons PC Header" style="width:100%; max-height:280px; object-fit:contain;" />
              </div>
              <div class="ds-header-mobile">
                <img src="https://raw.githubusercontent.com/antigravity/danielsimons/main/cabecera_mobile.svg" alt="Daniel Simons Mobile Header" style="width:100%; max-height:350px; object-fit:contain;" />
              </div>
...
try:
    ...
    print("SUCCESS: index_theme_danielsimons.xml created and passed XML test!")
