...
v19_path = os.path.join(output_dir, "v19_theme_optimizado.xml")
v17_path = os.path.join(output_dir, "v17_theme_optimizado.xml")

# Remove v19 if exists
if os.path.exists(v19_path):
    os.remove(v19_path)
    print("Deleted v19_theme_optimizado.xml successfully!")

# Ensure v17_theme_optimizado.xml exists and is valid
...
# HTML Frontpage Block V17 (ISOLATED SECTION BLOCKS FOR ISOLATED MODIFICATIONS)
