...
src_jpg = r"C:\Users\Usuario\.gemini\antigravity\brain\953edcf7-5053-4ba6-94e5-82edfed7e1d2\foto_real_articulo1_rm245_1785639328488.jpg"
...
print(f"Generated Realistic Article 1 WebP: {out_webp} (Size: {os.path.getsize(out_webp)/1024:.2f} KB)")
