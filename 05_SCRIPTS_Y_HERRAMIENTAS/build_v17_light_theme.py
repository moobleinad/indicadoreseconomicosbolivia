...
# Service thumbnails hosted via fast CDN URLs (Executive Desk & Project Blueprint Rembrandt photography)
URL_SERVICE_DESTILADO = "https://images.unsplash.com/photo-1455390582262-044cdead277a?auto=format&amp;fit=crop&amp;w=600&amp;h=600&amp;q=80"
URL_SERVICE_FORJA = "https://images.unsplash.com/photo-1507679799987-c73779587ccf?auto=format&amp;fit=crop&amp;w=600&amp;h=600&amp;q=80"
...
# HTML Frontpage Block V17 (CORRECT UNMATCHED THUMBNAILS FIX)
frontpage_html_block = f"""
            <b:if cond='data:view.isHomepage'>
              ...
              <!-- SECCIÓN 2: SERVICIOS DE ESTRUCTURACIÓN (REMOVED MISMATCHED BOOK COVERS, ADDED PROPER SERVICE PHOTOGRAPHY) -->
              <section class="ds-section-block">
                <div class="ds-section-header">
                ...
                <div class="ds-carousel-track" id="track-services">
                  <a href="{URL_DESTILADO}" class="ds-card-box">
                    <div>
                      <img src="{URL_SERVICE_DESTILADO}" alt="Destilado de Ideas" class="ds-card-thumb" />
                  ...
                  <a href="{URL_FORJA}" class="ds-card-box">
                    <div>
                      <img src="{URL_SERVICE_FORJA}" alt="Forja de Proyectos" class="ds-card-thumb" />
