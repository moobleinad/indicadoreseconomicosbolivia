...
# Images for Services Destilado and Forja
img_destilado_path = r"C:\Users\Usuario\.gemini\antigravity\brain\953edcf7-5053-4ba6-94e5-82edfed7e1d2\thumb_destilado_1785593994402.jpg"
img_forja_path = r"C:\Users\Usuario\.gemini\antigravity\brain\953edcf7-5053-4ba6-94e5-82edfed7e1d2\thumb_forja_1785594011419.jpg"
...
URI_DESTILADO_SERVICE = get_b64(img_destilado_path)
URI_FORJA_SERVICE = get_b64(img_forja_path)
...
# SEO Block
seo_block = """
  <!-- OPTIMIZACION SEO V17 DANIEL SIMONS -->
...
# HTML Frontpage Block V17 (SERVICIOS HAS ITS OWN PROPER SERVICE THUMBNAILS, BOOKS GO TO THEIR OWN SECTIONS)
frontpage_html_block = f"""
            <b:if cond='data:view.isHomepage'>
              ...
              <section class="ds-section-block">
                ...
                <div class="ds-carousel-track" id="track-posts">
                  <a href="{URL_POST_1}" class="ds-card-box">
                    <div>
                      <img src="{REAL_IMG_ART1}" alt="De la idea escolar al proyecto ordenado" class="ds-card-thumb" />
              ...
              <!-- SECCIÓN 2: SERVICIOS DE ESTRUCTURACIÓN (CON SUS FOTOS DE SERVICIO CORRECTAS) -->
              <section class="ds-section-block">
                <div class="ds-section-header">
                ...
                <div class="ds-carousel-track" id="track-services">
                  <a href="{URL_DESTILADO}" class="ds-card-box">
                    <div>
                      <img src="{URI_DESTILADO_SERVICE}" alt="Destilado de Ideas" class="ds-card-thumb" />
                  ...
                  <a href="{URL_FORJA}" class="ds-card-box">
                    <div>
                      <img src="{URI_FORJA_SERVICE}" alt="Forja de Proyectos" class="ds-card-thumb" />
              ...
              <!-- SECCIÓN 3: PROYECTOS PROPIOS & INVESTIGACIÓN (AQUÍ VA EL JUEGO DEL EMPRENDEDOR) -->
              <section class="ds-section-block">
                <div class="ds-section-header">
              ...
              <!-- SECCIÓN 5: TRABAJOS Y PROPUESTAS (AQUÍ VA LA GUÍA DE TESIS) -->
              <section class="ds-section-block">
                <div class="ds-section-header">
