...
output_path = os.path.join(output_dir, "v12_theme_optimizado.xml")

with open(source_path, "r", encoding="utf-8") as f:
    xml_content = f.read()

# Live URLs on Blogger & Clean Lightweight Image URLs
...
def make_b64_svg(emoji, title, desc):
    svg = f"""<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 400 400">
  <rect width="400" height="400" fill="#0d0d0d"/>
  <rect x="15" y="15" width="370" height="370" rx="10" fill="none" stroke="#bca772" stroke-width="2"/>
  <text x="200" y="160" font-size="65" text-anchor="middle">{emoji}</text>
  <text x="200" y="240" font-family="sans-serif" font-size="20" font-weight="bold" fill="#bca772" text-anchor="middle">{title}</text>
  <text x="200" y="275" font-family="sans-serif" font-size="13" fill="#888888" text-anchor="middle">{desc}</text>
</svg>"""
    return "data:image/svg+xml;base64," + base64.b64encode(svg.encode('utf-8')).decode('utf-8')

SVG_THUMB_DESTILADO = make_b64_svg("🧪", "DESTILADO DE IDEAS", "Claridad y Síntesis")
SVG_THUMB_FORJA = make_b64_svg("🔨", "FORJA DE PROYECTOS", "De la Idea a la Ejecución")
SVG_THUMB_MKT = make_b64_svg("📈", "MARKETING 360°", "Estrategia e Impacto")
SVG_THUMB_MYPE = make_b64_svg("🚀", "IMPULSO MYPE", "Acompañamiento Técnico")
SVG_THUMB_JUEGO = make_b64_svg("📘", "JUEGO EMPRENDEDOR", "Libro para Jóvenes")
SVG_THUMB_MFEIR = make_b64_svg("⚖️", "MODELO MFEIR", "Individualidades Relacionales")

# SEO Block
seo_block = """
  <!-- OPTIMIZACION SEO V12 DANIEL SIMONS -->
...
css_block = """
  ...
  /*<![CDATA[*/
    ...
    /* MINIATURA CUADRADA QUE LLENA EL 100% DEL ÁREA SUPERIOR */
    .ds-card-thumb {
      width: 100% !important;
      height: auto !important;
    ...
    /* TIPOGRAFÍA MÁS GRANDE EN CELULAR SEGÚN PEDIDO */
    @media (max-width: 767px) {
      .ds-card-box .title {
              ...
              <section class="ds-section-block">
                ...
                <div class="ds-carousel-track" id="track-posts">
                  <a href="{URL_POST_1}" class="ds-card-box">
                    <div>
                      <img src="{SVG_THUMB_JUEGO}" alt="De la idea escolar al proyecto ordenado" class="ds-card-thumb" />
              ...
              <section class="ds-section-block">
                ...
                <div class="ds-carousel-track" id="track-services">
                  <a href="{URL_DESTILADO}" class="ds-card-box">
                    <div>
                      <img src="{SVG_THUMB_DESTILADO}" alt="Destilado de Ideas" class="ds-card-thumb" />
                  ...
                  <a href="{URL_FORJA}" class="ds-card-box">
                    <div>
                      <img src="{SVG_THUMB_FORJA}" alt="Forja de Proyectos" class="ds-card-thumb" />
                  ...
                  <a href="{URL_MARKETING}" class="ds-card-box">
                    <div>
                      <img src="{SVG_THUMB_MKT}" alt="Marketing 360°" class="ds-card-thumb" />
                  ...
                  <a href="{URL_MYPE}" class="ds-card-box">
                    <div>
                      <img src="{SVG_THUMB_MYPE}" alt="Impulso MYPE" class="ds-card-thumb" />
              ...
              <section class="ds-section-block">
                ...
                <div class="ds-carousel-track" id="track-projects">
                  <a href="{URL_MFEIR}" class="ds-card-box">
                    <div>
                      <img src="{SVG_THUMB_MFEIR}" alt="Modelo MFEIR" class="ds-card-thumb" />
                  ...
                  <a href="{URL_JUEGO}" class="ds-card-box">
                    <div>
                      <img src="{SVG_THUMB_JUEGO}" alt="El Juego del Emprendedor" class="ds-card-thumb" />
              ...
              <section class="ds-section-block">
                ...
                <div class="ds-carousel-track" id="track-work">
                  <a href="{URL_URBANIZACIONES}" class="ds-card-box">
                    <div>
                      <img src="{SVG_THUMB_FORJA}" alt="Propuesta Urbanizaciones" class="ds-card-thumb" />
                  ...
                  <a href="{URL_TRANSPARENCIA}" class="ds-card-box">
                    <div>
                      <img src="{SVG_THUMB_DESTILADO}" alt="Transparencia Inteligente" class="ds-card-thumb" />
                  ...
                  <a href="{URL_ELECTORAL}" class="ds-card-box">
                    <div>
                      <img src="{SVG_THUMB_MFEIR}" alt="Estrategia Electoral 2026" class="ds-card-thumb" />
                  ...
                  <a href="{URL_TESIS}" class="ds-card-box">
                    <div>
                      <img src="{SVG_THUMB_JUEGO}" alt="Guía Sobreviviendo a la Tesis" class="ds-card-thumb" />
                  ...
                  <a href="{URL_MARCA}" class="ds-card-box">
                    <div>
                      <img src="{SVG_THUMB_MKT}" alt="Evaluar Desarrollo de Marca" class="ds-card-thumb" />
...
try:
    ...
    print("SUCCESS: v12_theme_optimizado.xml created and passed XML test!")
