...
3. **Redacción e Imagen:** El asistente redacta el artículo bajo normas de **Neuro-Redacción Utilitaria** (sin emojis ni líneas separadoras) y genera la imagen `.webp` oficial.
...
5. **Revisión y Subida de Imagen por Daniel:** Daniel sube o ajusta la imagen de la entrada desde el editor de Blogger si lo requiere.
...
add_sec("5. METODOLOGÍA OFICIAL DE PROPUESTA, REDACCIÓN Y PUBLICACIÓN AUTOMÁTICA VÍA API", [
    ...
    "3. Redacción e Imagen: Redacción bajo normas de Neuro-Redacción Utilitaria e imagen .webp oficial estilo Alt2 + Alt5.",
    "4. Publicación Directa vía API: El asistente publica la entrada directamente en Blogger vía la API oficial de Blogger.",
    "5. Revisión y Subida de Imagen por Daniel: Daniel ajusta o sube la imagen desde el editor de Blogger si lo requiere.",
...
add_sec("6. ESTRUCTURA DE ARTÍCULOS EN CARPETAS DEDICADAS Y SISTEMA NUMÉRICO", [
    "• CARPETAS INDIVIDUALES POR ARTÍCULO: Cada artículo se organizará dentro de su propia carpeta dedicada en 02_ARTICULOS_Y_PUBLICACIONES/ conteniendo exclusivamente sus 3 archivos: archivo .md, archivo .docx e imagen .webp oficial.",
...
print("SUCCESS: Updated Master MD and DOCX with Automatic API Publication Rule!")
